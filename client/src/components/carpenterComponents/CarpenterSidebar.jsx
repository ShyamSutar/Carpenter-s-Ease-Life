...
const CarpenterSidebar = () => {
  ...
  return (
    <div className="mr-16 sm:mr-56">
      <div className="h-screen fixed top-0 left-0 mt-16 bg-white shadow-lg py-4 px-2 md:p-4 md:px-6 text-gray-700 text-lg font-semibold">
        <ol>
          <Link
            to=""
