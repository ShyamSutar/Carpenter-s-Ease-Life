const About = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          ...
          <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">This is our final year project, Our mission is to empower carpenters and clients to work together seamlessly for successful outcomes.</p>
      </div> 
      <div className="grid gap-8 mb-6 lg:mb-16 lg:grid-cols-2">
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Shyam Sutar</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">Team Lead & Full Stack Developer</span>
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                  ...
                  <span className="text-gray-500 dark:text-gray-400">Presentation & Tester</span>
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                  ...
                  <span className="text-gray-500 dark:text-gray-400">Designer & Tester</span>
