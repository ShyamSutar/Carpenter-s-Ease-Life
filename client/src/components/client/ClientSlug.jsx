...
const ClientSlug = () => {
  ...
  return (
<div className="mt-24 max-w-7xl p-2 md:p-6 mx-auto space-y-8">
      {/* Header Section */}
      ...
      <div>
        {/* Plywood Details */}
        <div className="bg-white rounded-2xl px-2 py-4 md:p-6 shadow-lg border border-gray-100 mt-8 mb-3">
          <div className="flex items-center gap-3 mb-6">
        ...
        {/* Hardware Details */}
        <div className="bg-white rounded-2xl px-2 py-4 md:p-6 shadow-lg border border-gray-100 mt-6 mb-8">
          <div className="flex items-center gap-3 mb-6">
