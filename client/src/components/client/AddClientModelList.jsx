const AddClientModelList = ({ client, sendNotification }) => {
    return (
      <>
        <div className="mt-4 mr-2 flex justify-center">
          <div className="rounded-md border bg-slate-100 shadow-md w-[70vw]">
            <div className="w-full p-4">
              <h2 className="font-semibold">Name: {client.username}</h2>
              <h2 className="font-semibold">Email: {client.email}</h2>
            </div>
  ...
  export default AddClientModelList;
